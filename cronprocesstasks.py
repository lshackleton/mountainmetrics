...
class AddWeatherFetcherTask(webapp.RequestHandler):
  ...
  def get(self):
    ...
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=one)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=two)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=three)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=four)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=five)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=six)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=seven)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=eight)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=nine)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=ten)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=eleven)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=twelve)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=thirteen)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=fourteen)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=fifteen)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=sixteen)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=seventeen)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=eightteen)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=nineteen)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=twenty)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=twentyone)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=twentytwo)
    taskqueue.add(url='/tasks/process/WeatherFetcher', eta=twentythree)
...
class Addi80ConditionsFetcherTask(webapp.RequestHandler):
  ...
  taskqueue.add(url='/tasks/process/Addi80ConditionsFetcherTask')
